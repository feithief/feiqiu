                                     ...
                                     const QByteArray &value)
{
  ...
  /*
   * Mother-Seed rule: 0x2E only transmits.  Flash verification is performed
   * later by the unified 0x22 read-back; never wait for a 0x6E here.
   */
  if (false && service.expectPositiveWriteResponse)
  {
    QByteArray response;
