...
%   RGB/BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit_ratio16_runtime.c
%   triangle_grid_lut_output/AlgoRatioK_localfit_packed32_compat.c
%   RGB/BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit_packed32_compat.c

clear;
clc;

fprintf('\n============================================================\n');
fprintf('S06 DEV localfit ratio16 version: export runtime-grid AlgoRatioK_localfit_ratio16_runtime.c\n');
...
fprintf('Mirror: RGB/BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit_ratio16_runtime.c\n');
fprintf('============================================================\n\n');
...
compatScript = fullfile(scriptDir, 's06_export_ratioK_localfit_packed32_dev.m');
run(compatScript);
