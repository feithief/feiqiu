% S100_EXPORT_RATIOK_LOCALFIT_ALL_XIAOLI_20260528
% One-click export entry for localfit C files for
...
fprintf('\n============================================================\n');
fprintf('S100 Xiaoli 20260528 localfit export: one-click export all C variants\n');
...
headerFile = fullfile(repoRoot, 'RGB', '20260528小莉测试版', ...
    'BLINKY_SIMPLE_EXAMPLE_TLD4020', 'Algorithm', 'AlgoRatioK_localfit', 'AlgoRatioK_localfit.h');

ratio16Script = fullfile(scriptDir, 's06_export_ratioK_localfit_ratio16_xiaoli_20260528.m');
...
fprintf('  s100_export_ratioK_localfit_all_xiaoli_20260528.m\n');
