% S06_EXPORT_RATIOK_LOCALFIT_RATIO16_XIAOLI_20260528
% Export the MATLAB-generated LUT directly as runtime-grid AlgoRatioK_localfit.c
% for RGB/20260528小莉测试版/BLINKY_SIMPLE_EXAMPLE_TLD4020.
%
...
%   RGB/20260528小莉测试版/BLINKY_SIMPLE_EXAMPLE_TLD4020/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit_ratio16_runtime.c
%   triangle_grid_lut_output/AlgoRatioK_localfit_packed32_compat.c
%   RGB/20260528小莉测试版/BLINKY_SIMPLE_EXAMPLE_TLD4020/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit_packed32_compat.c

clear;
clc;

fprintf('\n============================================================\n');
fprintf('S06 Xiaoli 20260528 localfit ratio16 version: export runtime-grid AlgoRatioK_localfit_ratio16_runtime.c\n');
...
fprintf('Mirror: RGB/20260528小莉测试版/BLINKY_SIMPLE_EXAMPLE_TLD4020/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit_ratio16_runtime.c\n');
fprintf('============================================================\n\n');
...
compatScript = fullfile(scriptDir, 's06_export_ratioK_localfit_packed32_xiaoli_20260528.m');
run(compatScript);
