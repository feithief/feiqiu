% S06_EXPORT_RATIOK_LOCALFIT_ORIGINAL_DEV
% Export the MATLAB-generated LUT directly as the original packed32
% localfit implementation used by BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV.
%
% Input:
%   triangle_grid_lut_output/guangpu_triangle_grid_lut_results.csv
%
% Output:
%   triangle_grid_lut_output/AlgoRatioK_localfit_original_dev.c
%   RGB/BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit.c
%
% Packed LUT format:
...
fprintf('\n============================================================\n');
fprintf('S06 DEV original localfit version: export LUT to AlgoRatioK_localfit.c\n');
fprintf('Input : triangle_grid_lut_output/guangpu_triangle_grid_lut_results.csv\n');
fprintf('Output: triangle_grid_lut_output/AlgoRatioK_localfit_original_dev.c\n');
fprintf('Mirror: RGB/BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV/Algorithm/AlgoRatioK_localfit/AlgoRatioK_localfit.c\n');
fprintf('============================================================\n\n');
...
firmwareDir = fullfile(repoRoot, 'RGB', 'BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV', ...
    'Algorithm', 'AlgoRatioK_localfit');

inputFile = fullfile(outputDir, 'guangpu_triangle_grid_lut_results.csv');
outputFile = fullfile(outputDir, 'AlgoRatioK_localfit_original_dev.c');
firmwareOutputFile = fullfile(firmwareDir, 'AlgoRatioK_localfit.c');
