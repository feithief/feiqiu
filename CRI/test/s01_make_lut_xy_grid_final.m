...
fprintf('\n============================================================\n');
fprintf('S01 当前版本：基础 xy 三角网格，不启用自适应加密\n');
fprintf('三角网格点数 = (div+1)*(div+2)/2，当前 div=43 时为 990 点\n');
fprintf('============================================================\n\n');

%% ================= User configurable parameters =================
triangleGridDivCount = 150;      % 24 equal divisions on each RGB triangle edge, gives (24+1)*(24+2)/2 = 325 points
rayScanCount = 1001;            % Candidate RGB points per target ray
exportCHeader = true;           % Export compact C LUT header
cHeaderFileName = 'guangpu_triangle_grid_best_rgb_xygrid_lut.h';
...
%% Step 7: build adaptive triangular target grid in xy
baseGrid = make_triangle_target_grid_xy(actual_xyY.R(1:2), actual_xyY.G(1:2), actual_xyY.B(1:2), ...
    targetY_lm, triangleGridDivCount);

fprintf('\nBase uniform-xy triangle grid divisions = %d, point count = %d\n', ...
...
if adaptiveEnable
    ...
    centerGrid = make_triangle_cell_center_grid_xy(baseGrid, triangleGridDivCount, targetY_lm);
