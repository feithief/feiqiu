...
fprintf('\n============================================================\n');
fprintf('S100 DEV localfit export: one-click export all C variants\n');
...
headerFile = fullfile(repoRoot, 'RGB', 'BLINKY_SIMPLE_EXAMPLE_TLD4020_DEV', ...
    'Algorithm', 'AlgoRatioK_localfit', 'AlgoRatioK_localfit.h');

ratio16Script = fullfile(scriptDir, 's06_export_ratioK_localfit_ratio16_dev.m');
...
fprintf('  s100_export_ratioK_localfit_all_dev.m\n');
