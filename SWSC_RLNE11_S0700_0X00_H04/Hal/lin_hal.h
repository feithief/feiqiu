...
/**
   ...
   @par        Initializes LIN module for BSM Auto Addressing to start on 
               the next falling LIN edge (of the break field).
*/
void LinHa_Aa_Init(void);

/**
   @brief      Finish Auto Addressing
   @par        Calls LinHa_Aa_Stop() to stop AA 
               and disables restart on following LIN falling edges
*/
void LinHa_Aa_Finish(void);

/**
   @brief      Sets or resets AA addressed
   @par        Sets or resets the already addressed register bit field
   @param      val      value to set the addressed status (0..1)
*/
...
/*lin aa interrupt enable register*/
#define LIN_AA_MEAS_INT_EN             (LIN->LIN_IEN.bit.AA_MEAS_RDY_IEN)
#define LIN_AA_ERR_EN                  (LIN->LIN_IEN.bit.AA_ERR_IEN)
//#define LIN_AA_BREAK_FALL_INT_EN       (LIN->LIN_IEN.bit.EXF2EN)
/*lin aa interrupt enable register*/

/*lin aa status register*/
#define LIN_AA_STATUS_TBIT             (LIN->AA_STATUS.bit.TBIT_CNT)
#define LIN_AA_STATUS_ERRORCODE        (LIN->AA_STATUS.bit.ERR_CODE)
/*lin aa status register*/

/*lin aa fimware register*/
#define LIN_AA_FW_CONTROL_ALRDY_ADDR   (LIN->AA_FW_CTRL.bit.ALRDY_ADDR)
#define LIN_AA_FW_CONTROL_TO_BE_ADDR   (LIN->AA_FW_CTRL.bit.TO_BE_ADDR)
/*lin aa fimware register*/

/*lin aa control register*/
#define LIN_AA_CTRL_TBIT_START_MEAS    (LIN->AA_CTRL.bit.TBIT_START_MEAS)
#define LIN_AA_CTRL_TBIT_START_ISRC    (LIN->AA_CTRL.bit.TBIT_START_ISRC)
#define LIN_AA_CTRL_ISRC_CONF_CTRL     (LIN->AA_CTRL.bit.ISRC_CONF_CTRL)
#define LIN_AA_CTRL_ISRC_EN            (LIN->AA_CTRL.bit.ISRC_EN)
#define LIN_AA_CTRL_PU_DISC            (LIN->AA_CTRL.bit.PU_DISC)
#define LIN_AA_CTRL_PH_START           (LIN->AA_CTRL.bit.PH_START)
#define LIN_AA_CTRL_PH_STOP            (LIN->AA_CTRL.bit.PH_STOP)
#define LIN_AA_CTRL_FSM_RST            (LIN->AA_CTRL.bit.FSM_RST)
#define LIN_AA_CTRL_ISENSE_MEAS_NUMBER (LIN->AA_CTRL.bit.ISENSE_MEAS_NUMBER)
#define LIN_AA_CTRL_ISENSE_EN          (LIN->AA_CTRL.bit.ISENSE_EN)
#define LIN_AA_CTRL_ERR_CODE_CLR       (LIN->AA_CTRL.bit.ERR_CODE_CLR)
#define LIN_AA_CTRL_LIN_AA_EN          (LIN->AA_CTRL.bit.LIN_AA_EN)
#define LIN_AA_CTRL_LIN_AA_PH          (LIN->AA_CTRL.bit.LIN_AA_PH)
/*lin aa control register end*/

/*lin aa threshold register*/
#define LIN_AA_THRESHOLD_PRE_IDIFF     (LIN->AA_I_DIFF_TH.bit.I_DIFF_TH_1_VAL)
#define LIN_AA_THRESHOLD_SELECT_IDIFF  (LIN->AA_I_DIFF_TH.bit.I_DIFF_TH_2_VAL)
/*lin aa threshold register*/

/*lin aa meassure result register of LIM_S*/
#define LIN_AA_MEASURE_RES_LIN_S       (LIN->AA_ACC_RES_1.bit.ACC_RES_1)
/*lin aa meassure result register of LIM_S*/

/*lin aa meassure result register of LIM_M*/
#define LIN_AA_MEASURE_RES_LIN_M       (LIN->AA_ACC_RES_2.bit.ACC_RES_2)
/*lin aa meassure result register of LIM_M*/

#define LIN_AA_MEASURE_INT_CLR         (LIN->LIN_ISC.bit.AA_MEAS_RDY_CLR)
#define LIN_AA_ERR_INT_CLR             (LIN->LIN_ISC.bit.AA_ERR_CLR)

#define LIN_TIMER_CAP_REL              (LIN->T2_CON.bit.CP_RL2)
#define LIN_TIMER_EX_IN_SEL            (LIN->T2_CON.bit.T2EXINSEL)
#define LIN_TIMER_EXT_EN               (LIN->T2_CON.bit.EXEN2)
...
#define LIN_AA_CURRENT_SETTING_0_00MA         (0)
#define LIN_AA_CURRENT_SETTING_0_45MA         (1)
#define LIN_AA_CURRENT_SETTING_1_00MA         (2)
#define LIN_AA_CURRENT_SETTING_1_45MA         (3)
#define LIN_AA_CURRENT_SETTING_2_05MA         (4)
#define LIN_AA_CURRENT_SETTING_2_50MA         (5)
#define LIN_AA_CURRENT_SETTING_3_05MA         (6)
#define LIN_AA_CURRENT_SETTING_3_50MA         (7)
