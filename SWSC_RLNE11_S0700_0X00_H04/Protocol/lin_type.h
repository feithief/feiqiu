...
/* (MISRA-C:2004 18.4/R, e960) declaration of union type or object of union type
 * Reason: Rule is ignored, see DS for more details. */
/*lint -save -esym(960, 18.4) */
...
typedef struct
{
   l_u8 eventTriggeredFrame_id;
   l_u8 resolver_sched_id;
}t_lin_resolver_table;

/* (MISRA-C:2004 20.2/R, e960) Re-use of C90 identifier / identifier pattern
 * Reason: Due to compatibility with all supported derivatives and their HALs these
 * identifiers are not changed. */
typedef struct s_lin_hal_stat_reg
{
   l_u8 byte_received :1;
   l_u8 ferror        :1; /*lint !e960*/
   l_u8 stopbit       :1;
   l_u8 isr_rec_break :1; /*lint !e960*/
   l_u8 isr_rec_sync  :1; /*lint !e960*/
   l_u8 res0          :3;
} LIN_hal_stat_reg_t;
...
#endif /* end #ifdef USE_PACKED */
{
...
#endif /* end #ifdef USE_PACKED */
   {
      l_u8 PID;
      l_u8 DataBuffer[8];
      l_u8 reserved;           /* used for subscribe frames CRC */
      l_u8 BufferIndex;
   }frame;
