...
static const int16_t tempMcuRange[DTempRange]={
  -40 * DTEMP_MULTIPLIED_RATIO,        /*Level 0*/
   117* DTEMP_MULTIPLIED_RATIO,        /*Level 1*/
   121* DTEMP_MULTIPLIED_RATIO,        /*Level 2*/
   125* DTEMP_MULTIPLIED_RATIO,        /*Level 3*/
   129* DTEMP_MULTIPLIED_RATIO,        /*Level 4*/
   133* DTEMP_MULTIPLIED_RATIO,        /*Level 5*/
   137* DTEMP_MULTIPLIED_RATIO,        /*Level 6*/
   141* DTEMP_MULTIPLIED_RATIO,        /*Level 7*/
};

static const int16_t tempLedRange[DTempRange]={
  -40 * DTEMP_MULTIPLIED_RATIO,        /*Level 0*/
   106 * DTEMP_MULTIPLIED_RATIO,        /*Level 1*/
   109 * DTEMP_MULTIPLIED_RATIO,        /*Level 2*/
   112 * DTEMP_MULTIPLIED_RATIO,        /*Level 3*/
   115 * DTEMP_MULTIPLIED_RATIO,        /*Level 4*/
   118* DTEMP_MULTIPLIED_RATIO,        /*Level 5*/
   121* DTEMP_MULTIPLIED_RATIO,        /*Level 6*/
   125* DTEMP_MULTIPLIED_RATIO,        /*Level 7*/
};
//static const int16_t tempMcuRange[DTempRange]={
//   150 * DTEMP_MULTIPLIED_RATIO,        /*Level 0*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 1*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 2*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 3*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 4*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 5*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 6*/
//   150* DTEMP_MULTIPLIED_RATIO,        /*Level 7*/
//};
...
{
  int16_t temperatureLed = IoHwAb_Temperature_GetLed();
  int16_t temperatureMcu = IoHwAb_Temperature_GetMcu();
    ...
    for(int16_t i = 0;i < (DTempRange-1); i++)
    {
      ...
      if (((temperatureLed >= (tempLedRange[i] + 1*DTEMP_MULTIPLIED_RATIO)) &&
          (temperatureLed < (tempLedRange[i+1] - 1*DTEMP_MULTIPLIED_RATIO)))	&&
					(temperatureLed < (tempMcuRange[DTempRange - 2])))
      {
        currentLedLevel = i;
        break;
      }
			else if (((temperatureLed >= (tempLedRange[i] + 1*DTEMP_MULTIPLIED_RATIO)) &&
          (temperatureLed < (tempLedRange[i+1] - 1*DTEMP_MULTIPLIED_RATIO)))	&&
					(temperatureLed >= (tempMcuRange[DTempRange - 2])))
			{
        currentMcuLevel = i;
    ...
    for(int16_t i = 0;i < (DTempRange-1); i++)
    {
      ...
      if (((temperatureMcu >= (tempMcuRange[i] + 1*DTEMP_MULTIPLIED_RATIO)) &&
          (temperatureMcu < (tempMcuRange[i+1] - 1*DTEMP_MULTIPLIED_RATIO))) &&
					(temperatureMcu < (tempMcuRange[DTempRange - 2])) )
      {
        currentMcuLevel = i;
        break;
      }
			else if (((temperatureMcu >= (tempMcuRange[i] + 1*DTEMP_MULTIPLIED_RATIO)) &&
          (temperatureMcu < (tempMcuRange[i+1] - 1*DTEMP_MULTIPLIED_RATIO))) &&
					(temperatureMcu >= (tempMcuRange[DTempRange - 2])))
			{
        currentMcuLevel = i;
...
void systemTempDerating(SColorParams *inputColor)
{
  ...
  if (source == EDeratingSourceLed)
  {
    ...
    temperature = IoHwAb_Temperature_GetLed();
  }
  ...
  if (source == EDeratingSourceMcu)
  {
    ...
    temperature = IoHwAb_Temperature_GetMcu();
  }
