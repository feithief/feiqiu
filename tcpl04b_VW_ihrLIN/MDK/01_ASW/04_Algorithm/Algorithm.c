...
static const fix16_t intensityAdjustConst = F16(1.0394);//0.8
const int iii;
...
/*0*/{-40, 1482, 1060, 969, -73 , 75 ,-174 , 138  , 30 ,-44 },
/*1*/{-20 ,1325 ,1024 ,960  ,-50 , 52 ,-120  , 94  , 21 ,-30 },
/*2*/{-10 ,1240 ,1006 ,960  ,-39 , 41 ,-93  , 72  , 16 ,-24 },
/*3*/{0   ,1160 ,990 ,964  ,-28 , 29 ,-65  , 50   , 11 ,-17 },
/*4*/{25  ,1000 ,1000 ,1000 , 0  , 0  , 0   , 0   , 0  , 0  },
/*5*/{50  ,780  ,956  ,1003 , 29 ,-29 , 65  ,-51  ,-12 , 16 },
/*6*/{85  ,520  ,881  ,982 , 40 ,-67 , 163 ,-134  ,-28 , 40 },
/*7*/{120 ,260  ,811  ,978 , 85 ,-107 , 261 ,-214 ,-44 , 64 }
};
...
static void __algoGetDutyRatio(SColorParams * const inputColor, SCIEColor *MxyzY, SPWMParams *outputPWM)
{
  ...
  duty_r_aa = fix16_mul(duty_r_aa, F16(SWSC_PWM_PERIOD));
  duty_g_aa = fix16_mul(duty_g_aa, F16(SWSC_PWM_PERIOD));
  duty_b_aa = fix16_mul(duty_b_aa, F16(SWSC_PWM_PERIOD));
