#ifndef SWSC_FIXED_POINT_H
#define SWSC_FIXED_POINT_H

#include <stdint.h>

/** @file
*
* @defgroup FIXED_POINT_MODULE Q16.16 integer math.
* @{
*
* @brief Runtime calculations use signed integer Q16.16 arithmetic only.
*
* @details Decimal operands of F16 are compile-time constants; no floating-point
* runtime operation or floating-point support library is linked.
*/
