...
} SAlgoSonderfunktion2RatioCache;
                                                 ...
                                                 uint16_t *whiteRatio25Q10000)
{
    ...
    if ((gAlgoSonderfunktion2W25Cache.valid != 0u) &&
        (gAlgoSonderfunktion2W25Cache.targetU == targetU) &&
        (gAlgoSonderfunktion2W25Cache.targetV == targetV))
    {
        *whiteRatio25Q10000 = gAlgoSonderfunktion2W25Cache.whiteRatio25Q10000;
        return gAlgoSonderfunktion2W25Cache.ratioValid;
    }

    ratioQ10000 = 0u;
    ratioValid = AlgoRatioK_GetWhiteRatioQ10000(targetU,
                                                targetV,
                                                &ratioQ10000);

    gAlgoSonderfunktion2W25Cache.valid = 1u;
    gAlgoSonderfunktion2W25Cache.ratioValid = ratioValid;
    gAlgoSonderfunktion2W25Cache.targetU = targetU;
    gAlgoSonderfunktion2W25Cache.targetV = targetV;
    gAlgoSonderfunktion2W25Cache.whiteRatio25Q10000 = ratioQ10000;

    *whiteRatio25Q10000 = ratioQ10000;
    return ratioValid;
}

static uint8_t __algoGetSonderfunktion2WhiteRatioCached(SColorParams * const inputColor,
                                                        uint16_t originalTargetU,
                                                        uint16_t originalTargetV,
                                                        ...
                                                        uint16_t *whiteRatioQ10000)
{
    ...
    uint16_t currentTargetV;
    uint16_t whiteRatio25Q10000;
    uint16_t whiteRatioFinalQ10000;

    mode = sysLin_Stack.RGB.BCM_RGB_Sonderfunktion;
    currentTargetU = (uint16_t)inputColor->colorU;
    currentTargetV = (uint16_t)inputColor->colorV;

    if ((gAlgoSonderfunktion2RatioCache.valid != 0u) &&
        (gAlgoSonderfunktion2RatioCache.mode == mode) &&
        (gAlgoSonderfunktion2RatioCache.originalTargetU == originalTargetU) &&
        (gAlgoSonderfunktion2RatioCache.originalTargetV == originalTargetV) &&
        (gAlgoSonderfunktion2RatioCache.currentTargetU == currentTargetU) &&
        (gAlgoSonderfunktion2RatioCache.currentTargetV == currentTargetV) &&
        (gAlgoSonderfunktion2RatioCache.temperatureDegC_X10 == correctionTemperatureDegC_X10))
    {
        *whiteRatioQ10000 = gAlgoSonderfunktion2RatioCache.whiteRatioQ10000;
        return gAlgoSonderfunktion2RatioCache.ratioValid;
    }

    ratioValid = __algoGetSonderfunktion2W25Cached(currentTargetU,
                                                   currentTargetV,
                                                   &whiteRatio25Q10000);

    whiteRatioFinalQ10000 = whiteRatio25Q10000;
    if (ratioValid != 0u)
    {
                                                           ...
                                                           currentTargetV))
        {
            ...
            gAlgoSonderfunktion2DebugW25RawQ10000 = whiteRatio25Q10000;
            gAlgoSonderfunktion2DebugW25SafeQ10000 = whiteRatio25Q10000;
            gAlgoSonderfunktion2DebugDeltaWQ10000 = 0;
            gAlgoSonderfunktion2DebugWformulaQ10000 = whiteRatio25Q10000;
#endif
        }
        else
        {
            whiteRatioFinalQ10000 = __algoApplyTemperatureWhiteRatioCorrection(currentTargetU,
                                                                               currentTargetV,
                                                                               whiteRatio25Q10000,
    ...
    gAlgoSonderfunktion2RatioCache.valid = 1u;
    gAlgoSonderfunktion2RatioCache.mode = mode;
    gAlgoSonderfunktion2RatioCache.ratioValid = ratioValid;
    gAlgoSonderfunktion2RatioCache.originalTargetU = originalTargetU;
    gAlgoSonderfunktion2RatioCache.originalTargetV = originalTargetV;
    gAlgoSonderfunktion2RatioCache.currentTargetU = currentTargetU;
    gAlgoSonderfunktion2RatioCache.currentTargetV = currentTargetV;
    gAlgoSonderfunktion2RatioCache.temperatureDegC_X10 = correctionTemperatureDegC_X10;
    gAlgoSonderfunktion2RatioCache.whiteRatioQ10000 = whiteRatioFinalQ10000;

    *whiteRatioQ10000 = whiteRatioFinalQ10000;
    return ratioValid;
}
                                     ...
                                     SPWMParams *outputPWM)
{
    ...
    ratioValid = __algoGetSonderfunktion2WhiteRatioCached(inputColor,
                                                          originalTargetU,
                                                          originalTargetV,
                                                          correctionTemperatureDegC_X10,
                                                          &whiteRatioQ10000);
