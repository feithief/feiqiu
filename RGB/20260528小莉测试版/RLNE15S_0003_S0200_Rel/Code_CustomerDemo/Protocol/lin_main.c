...
void lin_main_init(void)
{
   ...
   g_lin_prod_id.Supplier_lo = g_st_SavedConfig.au8_ProductID[0];
   g_lin_prod_id.Supplier_hi = g_st_SavedConfig.au8_ProductID[1];
   g_lin_prod_id.Function_lo = g_st_SavedConfig.au8_ProductID[2];
   g_lin_prod_id.Function_hi = g_st_SavedConfig.au8_ProductID[3];
   g_lin_prod_id.Variant = g_st_SavedConfig.au8_ProductID[4];
