...
// uint16_t Debug;
/**@brief Service list.*/
#define DMAX_SERVICE_AMOUNT 25//15
...
static const SLinDiagSevice serveceList[DMAX_SERVICE_AMOUNT] =
{
  ...
  {0x000B,  DS_WRITE| DS_READ , NAD_CAL, 			8u, 						(uint8_t*)&(savedConfig.whiteRgbMixParams.rgbPointX)},  
  {0x0100,  DS_READ           , NAD_NORLCAL, 		12, 						(uint8_t*)&(Debug_0100)},
...
//					Debug_0100[0] = sysLin.RGB.BCM_RGB_Intensitaet;
					Debug_0100[0] = moduleTempMcuGet_debug();
//          Debug_0100[0] =   moduleTempMcuGet();
//    	  Debug_0100[3] =  savedConfig.ledSupplier;
          Debug_0100[1] = moduleTempLedGet();
          Debug_0100[2] =   moduleLedGetPWM(ELedChannelRed);
          Debug_0100[3] =   moduleLedGetPWM(ELedChannelGreen);
          Debug_0100[4] =   moduleLedGetPWM(ELedChannelBlue);
          Debug_0100[5] =   moduleLedGetPWM(ELedChannelWhite);
