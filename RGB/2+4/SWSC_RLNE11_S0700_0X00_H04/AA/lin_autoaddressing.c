...
#define LIN_AA_ADC_REINIT_FAST()       do { ADC11->CFG_0.reg = ((uint32_t)ADC11_CFG_0 | (0x3u << 20)); ADC11->IEN.reg = (uint32_t)ADC11_IEN; ADC11->CFG_1.reg = (uint32_t)ADC11_CFG_1; } while (0)
