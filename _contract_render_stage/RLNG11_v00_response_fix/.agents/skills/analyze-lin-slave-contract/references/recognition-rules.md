...
`positive_write_response_echo_mode=did_or_final_consecutive_data` with evidence
from both the transport call site and response builder. Keep the default mode
`did`; never enable this compatibility from a trace alone or for all projects.
