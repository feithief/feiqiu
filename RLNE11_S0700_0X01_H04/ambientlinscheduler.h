...
public:
  ...
  quint32 lockNode(quint8 node) override;
  quint32 unlockNode(quint8 node) override;
...
signals:
  ...
  void lockNodeRequested(quint32 requestId, quint8 node);
  void unlockNodeRequested(quint32 requestId, quint8 node);
