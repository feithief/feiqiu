...
#ifndef __IO_E52139A_IAR_H
#define __IO_E52139A_IAR_H

#ifdef __IAR_SYSTEMS_ICC__
  #include "io_e52139a_macros.h"
...
typedef struct {
  ...
  __REG16 lin_hs             :  1;       /* [1] */
  __REG16                    :  9;
  __REG16 bus_short_debounce :  3;       /* [13:11] */
  __REG16                    :  2;
...
/* PHY_STATUS bitfield type ... */

typedef struct {
  __REG16 bus_short :  1;       /* [0] */
  __REG16           : 15;
} lin_ctrl_phy_status_bf_t;

/* PHY_STATUS single bit enum ... */

enum {
  E_LIN_CTRL_PHY_STATUS_BUS_SHORT = 0x0001u
};

/* PHY_STATUS address mapping ... */

__IO_REG16_BIT(LIN_CTRL_PHY_STATUS, 0x00000282u, __READ, lin_ctrl_phy_status_bf_t);
...
enum {
  ...
  E_LIN_CTRL_AA_PHY_CONFIG_FILTER        = 0x0008u,
  E_LIN_CTRL_AA_PHY_CONFIG_OFFSET_SELECT = 0x0010u,
...
typedef struct {
  ...
  __REG16                           :  1;
  __REG16 reverse_current_detection :  1;       /* [14] */
...
enum {
  E_LIN_CTRL_AA_TYPE3_RAMP_CONFIG_REVERSE_CURRENT_DETECTION = 0x4000u,
...
enum {
  E_LIN_CTRL_IRQ_STATUS_BUS_SHORT_EVT                   = 0x0001u,
...
typedef struct {
  __REG32 trim_lin_aa_type1_cm_error :  5;       /* [4:0] */
  __REG32 tlin_aa_trim_offset_error  :  4;       /* [8:5] */
  __REG32 lock                       :  1;       /* [9] */
  __REG32                            : 22;
...
enum {
  E_CAL_SYS_STATE_TRIM_LIN_AA_TYPE1_LOCK                       = 0x00000200u
};
...
typedef struct {
  __REG32 trim_lin_aa_type2_3_cm_error     :  5;       /* [4:0] */
  __REG32 lin_aa_trim_type2_3_offset_error :  4;       /* [8:5] */
  __REG32 lock                             :  1;       /* [9] */
  __REG32                                  : 22;
...
enum {
  E_CAL_SYS_STATE_TRIM_LIN_AA_TYPE2_3_LOCK                             = 0x00000200u
};
