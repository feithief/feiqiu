 ...
 * @{
 * @addtogroup LIN_M52139A M52139A
 * @{
 *
 * $Id: LinBus_Implementation.h 9445 2021-11-23 09:35:02Z poe $
 *
 * $Revision: 9445 $
 *
 ******************************************************************************
...
/* ************************ DEFINES AND MACROS ********************************/
/* ****************************************************************************/
#define LINBUSIMP_CONFIG_DATA_VERSION      (0x0102u)  /**< Expected config data version */
...
typedef enum 
{
  LinBusImp_SNPD_T3_REVERSECURRDETECT_OFF             = 0u, /**< Disable reverse current detection for type 3 auto addressing. */
  LinBusImp_SNPD_T3_REVERSECURRDETECT_ON              = 1u  /**< Enable reverse current detection for type 3 auto addressing. */
    
} LinBusImp_eSNPDT3ReverseCurrentDetect_t;

#define LinBusImp_SNPD_T3_REVCURRDETECT_DEFAULT LinBusImp_SNPD_T3_REVERSECURRDETECT_ON
...
#define LinBusImp_SNPD_OUTPUT_CURRENT_DEFAULT LinBusImp_SNPD_OUTPUT_CURRENT_LIN_S
...
#define LinBusImp_SNPD_LIN_AA_GAIN_TYPE1_DEFAULT  0u
...
typedef struct
{
  LinBusImp_eSNPDT3ReverseCurrentDetect_t   EnableType3ReverseCurrentDetection;
...
/***************************************************************************//**
 * Data type definition for AA Filter select
 ******************************************************************************/
typedef enum
{
  LinBusImp_AAFILTER_DISABLED = 0u,
  LinBusImp_AAFILTER_ENABLED  = 1u
} LinBusImp_eAAFilterSelect_t;

/***************************************************************************//**
 * Data type definition for AA Offset select
 ******************************************************************************/
typedef enum
{
  LinBusImp_AAOFFSET_LOW    = 0u,
  LinBusImp_AAOFFSET_HIGH   = 1u
} LinBusImp_eAAOffsetSelect_t;
...
typedef struct
{
  ...
  LinBusImp_eAAFilterSelect_t               EnableFilter            ;
  LinBusImp_eAAOffsetSelect_t               OffsetSelect            ;
...
/***************************************************************************//**
 * Data type definition for Short detection debounce selection
 ******************************************************************************/
typedef enum
{
  LinBusImp_SHORTDETECTDEBOUNCE_BYPASS  = 0u,
  LinBusImp_SHORTDETECTDEBOUNCE_41NS    = 1u,
  LinBusImp_SHORTDETECTDEBOUNCE_164NS   = 2u,
  LinBusImp_SHORTDETECTDEBOUNCE_333NS   = 3u,
  LinBusImp_SHORTDETECTDEBOUNCE_666NS   = 4u,
  LinBusImp_SHORTDETECTDEBOUNCE_1333NS  = 5u,
  LinBusImp_SHORTDETECTDEBOUNCE_2666NS  = 6u,
  LinBusImp_SHORTDETECTDEBOUNCE_5333NS  = 7u

} LinBusImp_eShortDetectDebounceSelect_t;
 ...
 ******************************************************************************/
struct LinBusImp_sType3MeasOnlyConfig
{
  LinBusImp_eType3MeasOnly_t EnableMeasOnlyUsage;
  LinBusImp_MaxShuntConfig_t MaxShuntMeasConfig;
};

typedef struct  LinBusImp_sType3MeasOnlyConfig        LinBusImp_Type3MeasOnlyConfig_t;
typedef         LinBusImp_Type3MeasOnlyConfig_t*      LinBusImp_pType3MeasOnlyConfig_t;
typedef const   LinBusImp_Type3MeasOnlyConfig_t*      LinBusImp_cpType3MeasOnlyConfig_t;
...
struct LinBusImp_sCfgData
{
  ...
  LinBusImp_eShortDetectDebounceSelect_t        ShortDetectDebouncerValue;  
  ...
  LinBusImp_Type3MeasOnlyConfig_t               Type3MeasConfig;
  LinBusImp_Type12LINSwapDetectConfig_t         SNPDLINSwapCheck_Enable;
  LinBusImp_Type12LINSwapCancelOnError_t        SNPDLINSwapCancelOnError;
  LinBusImp_SNPDThres_t                         SNPDLINSwapCheck_ThdPresel;        
  LinBusImp_SNPDThres_t                         SNPDLINSwapCheck_ThdSel;
