 ...
 * @{
 *
 * $Id: Lin_Basictypes_ACM0_IAR.h 8305 2021-02-03 13:29:35Z poe $
 *
 * $Revision: 8305 $
 *
 ******************************************************************************
 ...
 *
 ******************************************************************************/
#ifndef LIN_BASICTYPES_ACM0_IAR_H_
#define LIN_BASICTYPES_ACM0_IAR_H_
...
#define LIN_TRUE  (1U)           /**< Indicates a 'true' condition of a particular Lin_Bool_t */
#define LIN_FALSE (0U)           /**< Indicates a 'false' condition of a particular Lin_Bool_t */
...
typedef unsigned char     Lin_uint8_t;   /**< Unsigned 8 bit data type. */
typedef unsigned short    Lin_uint16_t;  /**< Unsigned 16 bit data type. */
typedef unsigned long int Lin_uint32_t;  /**< Unsigned 32 bit data type. */

typedef signed char       Lin_sint8_t;   /**< Signed 8 bit data type. */
typedef signed short      Lin_sint16_t;  /**< Signed 16 bit data type. */
typedef signed long int   Lin_sint32_t;  /**< Signed 32 bit data type. */

typedef unsigned char     Lin_Bool_t;	 /**< A boolean data type */
...
typedef Lin_uint16_t      Lin_EnvDataSze_t;                       /**< Generic type for the environment data size. */
...
#endif /* LIN_BASICTYPES_ACM0_IAR_H_ */
/*! @} */ /* ELMOS_LIN_DRIVER */
