...
static const int16_t tempMcuRange[DTempRange]={
  -40 * DTEMP_MULTIPLIED_RATIO,        /*Level 0*/
   115* DTEMP_MULTIPLIED_RATIO,        /*Level 1*/
   118* DTEMP_MULTIPLIED_RATIO,        /*Level 2*/
   121* DTEMP_MULTIPLIED_RATIO,        /*Level 3*/
   124* DTEMP_MULTIPLIED_RATIO,        /*Level 4*/
   127* DTEMP_MULTIPLIED_RATIO,        /*Level 5*/
   130* DTEMP_MULTIPLIED_RATIO,        /*Level 6*/
   133* DTEMP_MULTIPLIED_RATIO,        /*Level 7*/
};

static const int16_t tempLedRange[DTempRange]={
  -40 * DTEMP_MULTIPLIED_RATIO,        /*Level 0*/
   90 * DTEMP_MULTIPLIED_RATIO,        /*Level 1*/
   93 * DTEMP_MULTIPLIED_RATIO,        /*Level 2*/
   96 * DTEMP_MULTIPLIED_RATIO,        /*Level 3*/
   99 * DTEMP_MULTIPLIED_RATIO,        /*Level 4*/
   102* DTEMP_MULTIPLIED_RATIO,        /*Level 5*/
   105* DTEMP_MULTIPLIED_RATIO,        /*Level 6*/
   108* DTEMP_MULTIPLIED_RATIO,        /*Level 7*/
};
