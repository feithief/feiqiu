...
"};"));
    ...
    void retranslateUi(QWidget *SlaveNodeFrame)
    {
        ...
        labelSWVerNumTitle->setText(QApplication::translate("SlaveNodeFrame", "SWVerNum:", 0));
        labelSWVerNum->setText(QString());
        labelErrRespTitle->setText(QApplication::translate("SlaveNodeFrame", "ErrResp:", 0));
        labelErrResp->setText(QString());
        labelHWVerNumTitle->setText(QApplication::translate("SlaveNodeFrame", "HWVerNum:", 0));
