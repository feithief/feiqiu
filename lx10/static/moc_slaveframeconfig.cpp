...
void SlaveWriteThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveWriteThread::WrittingFinished)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SlaveWriteThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SlaveWriteThread.data,
      qt_meta_data_SlaveWriteThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SlaveWriteThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SlaveWriteThread.stringdata0))
        return static_cast<void*>(const_cast< SlaveWriteThread*>(this));
...
void SlaveInitThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::SWFetched)) {
                *result = 0;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::HWFetched)) {
                *result = 1;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::SuppFetched)) {
                *result = 2;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::FuncFetched)) {
                *result = 3;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::VariantFetched)) {
                *result = 4;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::SAFetched)) {
                *result = 5;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::GAFetched)) {
                *result = 6;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::PlatformFetched)) {
                *result = 7;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::IntensityFetched)) {
                *result = 8;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::LockFetched)) {
                *result = 9;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(CalibrationInfo );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::RFetched)) {
                *result = 10;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(CalibrationInfo );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::GFetched)) {
                *result = 11;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(CalibrationInfo );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::BFetched)) {
                *result = 12;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::PNFetched)) {
                *result = 13;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::SerialFetched)) {
                *result = 14;
            }
        }
        {
            typedef void (SlaveInitThread::*_t)(bool , ENodeType );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SlaveInitThread::fechingFinished)) {
                *result = 15;
            }
        }
    }
...
const QMetaObject SlaveInitThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_SlaveInitThread.data,
      qt_meta_data_SlaveInitThread,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SlaveInitThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SlaveInitThread.stringdata0))
        return static_cast<void*>(const_cast< SlaveInitThread*>(this));
    return QThread::qt_metacast(_clname);
}
...
const QMetaObject SlaveFrameConfig::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_SlaveFrameConfig.data,
      qt_meta_data_SlaveFrameConfig,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SlaveFrameConfig::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SlaveFrameConfig.stringdata0))
        return static_cast<void*>(const_cast< SlaveFrameConfig*>(this));
