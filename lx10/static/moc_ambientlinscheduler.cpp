...
#include "../AmbientDevice/ambientlinscheduler.h"
...
QT_MOC_LITERAL(5, 59, 10), // "timerStart"
QT_MOC_LITERAL(6, 70, 16), // "colorGroupChange"
QT_MOC_LITERAL(7, 87, 16) // "timershouldstart"

    },
    "AmbientLinScheduler\0SlaveStatusChanged\0"
    "\0SlaveStatus\0status\0timerStart\0"
    "colorGroupChange\0timershouldstart"
};
...
void AmbientLinScheduler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->colorGroupChange(); break;
        case 3: _t->timershouldstart(); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AmbientLinScheduler::SlaveStatusChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (AmbientLinScheduler::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&AmbientLinScheduler::timerStart)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject AmbientLinScheduler::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_AmbientLinScheduler.data,
      qt_meta_data_AmbientLinScheduler,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *AmbientLinScheduler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_AmbientLinScheduler.stringdata0))
        return static_cast<void*>(const_cast< AmbientLinScheduler*>(this));
...
// SIGNAL 1
void AmbientLinScheduler::timerStart()
{
