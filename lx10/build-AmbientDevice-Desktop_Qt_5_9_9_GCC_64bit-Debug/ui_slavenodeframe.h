...
"};"));
    ...
    {
        SlaveNodeFrame->setWindowTitle(QApplication::translate("SlaveNodeFrame", "Form", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("SlaveNodeFrame", "Slave Node Status And  Configuration", Q_NULLPTR));
        labelDimRamp_8->setText(QApplication::translate("SlaveNodeFrame", "Version Report", Q_NULLPTR));
        labelSuppTitle->setText(QApplication::translate("SlaveNodeFrame", "Supplier ID:", Q_NULLPTR));
        labelSWTitle->setText(QApplication::translate("SlaveNodeFrame", "SW Ver:", Q_NULLPTR));
        labelHWTitle->setText(QApplication::translate("SlaveNodeFrame", "HW Ver:", Q_NULLPTR));
        labelFuncTitle->setText(QApplication::translate("SlaveNodeFrame", "Function ID:", Q_NULLPTR));
        labelVarTitle->setText(QApplication::translate("SlaveNodeFrame", "Varaint ID:", Q_NULLPTR));
        labelFuncVer->setText(QString());
        labelVariantVer->setText(QString());
        labelSWVer->setText(QString());
        labelSuppVer->setText(QString());
        labelTitleStatus->setText(QApplication::translate("SlaveNodeFrame", "Status Report:", Q_NULLPTR));
        labelSWVerNumTitle->setText(QApplication::translate("SlaveNodeFrame", "SWVerNum:", Q_NULLPTR));
        labelSWVerNum->setText(QString());
        labelErrRespTitle->setText(QApplication::translate("SlaveNodeFrame", "ErrResp:", Q_NULLPTR));
        labelErrResp->setText(QString());
        labelHWVerNumTitle->setText(QApplication::translate("SlaveNodeFrame", "HWVerNum:", Q_NULLPTR));
        labelHWVerNum->setText(QString());
        labelLuminous->setText(QApplication::translate("SlaveNodeFrame", "Luminous", Q_NULLPTR));
        labelBlueAttr->setText(QApplication::translate("SlaveNodeFrame", "Blue Color Attr:", Q_NULLPTR));
        labelRedAttr->setText(QApplication::translate("SlaveNodeFrame", "Red Color Attr:", Q_NULLPTR));
        labelYCoordinate->setText(QApplication::translate("SlaveNodeFrame", "Y Coordinate", Q_NULLPTR));
        labelGteenAttr->setText(QApplication::translate("SlaveNodeFrame", "Green Color Attr:", Q_NULLPTR));
        labelXCoordinate->setText(QApplication::translate("SlaveNodeFrame", "X Coordinate", Q_NULLPTR));
        pushButtonCancel->setText(QApplication::translate("SlaveNodeFrame", "Exit", Q_NULLPTR));
        pushButtonAccept->setText(QApplication::translate("SlaveNodeFrame", "Apply", Q_NULLPTR));
        pushButtonUnlock->setText(QApplication::translate("SlaveNodeFrame", "Unlocked", Q_NULLPTR));
        labelSerialNO->setText(QApplication::translate("SlaveNodeFrame", "Serial NO.:", Q_NULLPTR));
        lineEditPN->setText(QString());
        labelLockState->setText(QApplication::translate("SlaveNodeFrame", "Lock State:", Q_NULLPTR));
        labelPartNO->setText(QApplication::translate("SlaveNodeFrame", "Part NO.:", Q_NULLPTR));
        lineEditSerial->setText(QString());
        pushButtonLock->setText(QApplication::translate("SlaveNodeFrame", "Locked", Q_NULLPTR));
        labelGroupAddr->setText(QApplication::translate("SlaveNodeFrame", "CtrlList:", Q_NULLPTR));
        labelSingleAddr->setText(QApplication::translate("SlaveNodeFrame", "Frame ID:", Q_NULLPTR));
        labelPlatform->setText(QApplication::translate("SlaveNodeFrame", "Platform:", Q_NULLPTR));
        labelIntensity->setText(QApplication::translate("SlaveNodeFrame", "Intensity:", Q_NULLPTR));
        labelTitle_2->setText(QApplication::translate("SlaveNodeFrame", "Slave Node Configuration", Q_NULLPTR));
        labelTitleCalibration->setText(QApplication::translate("SlaveNodeFrame", "Calibration Function", Q_NULLPTR));
        pushButtonCalibrateR->setText(QApplication::translate("SlaveNodeFrame", "RED", Q_NULLPTR));
        pushButtonCalibrateG->setText(QApplication::translate("SlaveNodeFrame", "GREEN", Q_NULLPTR));
        pushButtonCalibrateB->setText(QApplication::translate("SlaveNodeFrame", "BLUE", Q_NULLPTR));
        pushButtonNoCalibrate->setText(QApplication::translate("SlaveNodeFrame", "Normal", Q_NULLPTR));
