...
"}"));
    ...
    {
        unlockFrom->setWindowTitle(QApplication::translate("unlockFrom", "Form", Q_NULLPTR));
        pushButtonCancel->setText(QApplication::translate("unlockFrom", "EXIT", Q_NULLPTR));
        labelTitle->setText(QApplication::translate("unlockFrom", "Unlock Advanced feature", Q_NULLPTR));
        labelUnlockCode->setText(QApplication::translate("unlockFrom", "Unlock Code:", Q_NULLPTR));
        labelCode->setText(QString());
        lineEditCode->setText(QString());
        pushButtonConfirm->setText(QApplication::translate("unlockFrom", "Confirm", Q_NULLPTR));
        pushButtonSelMaster->setText(QApplication::translate("unlockFrom", "Master", Q_NULLPTR));
        pushButtonSelFactory->setText(QApplication::translate("unlockFrom", "Factory", Q_NULLPTR));
        labelUnlockSelection->setText(QApplication::translate("unlockFrom", "Unlock Function:", Q_NULLPTR));
        pushButtonSelSlave->setText(QApplication::translate("unlockFrom", "Slave", Q_NULLPTR));
    } // retranslateUi
